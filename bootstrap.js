...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "WeatherApp.controller.Main": [],
  "WeatherApp.model.Day": [],
  "WeatherApp.model.Days": [],
  "WeatherApp.store.CityWeather": [],
  "WeatherApp.store.SixteenDaysCityWeather": [],
  "WeatherApp.store.WeekCityWeather": [],
  "WeatherApp.templates.CurDay": [],
  "WeatherApp.templates.Day": [],
  "WeatherApp.templates.FiveDays": [],
  "WeatherApp.view.Main": [],
  "WeatherApp.view.MainContainer": [],
  "WeatherApp.view.MainHeader": [],
  "WeatherApp.view.Viewport": [],
  "WeatherApp.view.tab.CurrentWeather": [],
  "WeatherApp.view.tab.SixteenDaysWeather": [],
  "WeatherApp.view.tab.WeekWeather": []
});
...
Ext.Loader.loadScriptFile('packages/local/my-custom-theme/overrides/init.js', Ext.emptyFn);
